...
class keys:
    def __init__(self):
        pygame.init()
        self.keys = {pygame.K_a:"a", pygame.K_b:"b", pygame.K_c:"c", pygame.K_d:"d", pygame.K_e:"e", pygame.K_f:"f", pygame.K_g:"g",
            ...
            pygame.K_x:"x", pygame.K_y:"y", pygame.K_z:"z", pygame.K_SPACE:" ", pygame.K_COMMA:",", pygame.K_QUOTE:"'", pygame.K_QUOTEDBL:'"'}
